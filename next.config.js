...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://logo.clearbit.com https://www.google.com https://icon.horse",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://rpc.testnet.arc.network https://ipapi.co https://open.er-api.com https://api.openai.com",
